...
const DEFAULT_HERO = {
  badge: 'Certified Organic Since 1985',
  title: 'Farm-fresh organic produce',
  titleHighlight: 'delivered to your door',
  description:
    "Experience the pure taste of sustainably grown vegetables, fruits, and herbs from our family farm. Supporting local agriculture and your family's health.",
  features: ['100% Certified Organic', 'Harvested Daily', 'Zero Pesticides', 'Local Family Farm'],
  primaryCTA: 'Shop Fresh Produce',
  secondaryCTA: 'Farm Tour',
  primaryCTAHref: '/',
  secondaryCTAHref: '/',
  imageUrl:
    'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?q=80&w=1920&auto=format&fit=crop',
  imageAlt: 'Fresh organic vegetables from Green Acres Farm',
  statsLabel1: 'Farm Size',
  statsValue1: '150 Acres',
  statsLabel2: 'Weekly Harvest',
  statsValue2: '2000+ lbs',
} as const;
