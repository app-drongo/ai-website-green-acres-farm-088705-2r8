...
export default function Footer({
  logoText = 'Green Acres Farm',
  companyDescription = "Providing fresh, organic produce and sustainable farming practices to our community for over 30 years. From farm to table, we're committed to quality and environmental stewardship.",
  contactEmail = 'info@greenacresfarm.com',
  contactPhone = '+1 (555) 234-FARM',
  contactAddress = '1847 Rural Route 12, Farmington Valley',
  newsletterTitle = 'Farm Fresh Updates',
  newsletterDisclaimer = 'Get weekly harvest updates and seasonal recipes. No spam, just fresh content.',
  section1Title = 'Farm Products',
  section2Title = 'About Us',
  section3Title = 'Resources',
  section4Title = 'Policies',
  copyrightText = '© 2024 Green Acres Farm. All rights reserved.',
  madeWithText = 'with love from our farm family',
  socialText = 'Follow our harvest:',
  social1Href = 'https://twitter.com/greenacresfarm',
  social2Href = 'https://facebook.com/greenacresfarm',
  social3Href = 'https://instagram.com/greenacresfarm',
  social4Href = 'https://linkedin.com/company/greenacresfarm',
  social5Href = 'https://github.com/greenacresfarm',
}: FooterProps) {
  const footerSections = [
    {
      title: section1Title,
      links: [
        { name: 'Seasonal Produce', href: '/produce' },
        { name: 'Organic Vegetables', href: '/vegetables' },
        { name: 'Fresh Fruits', href: '/fruits' },
        { name: 'Herbs & Greens', href: '/herbs' },
        { name: 'Farm Eggs', href: '/eggs' },
        { name: 'Preserves & Jams', href: '/preserves' },
      ],
    },
    {
      title: section2Title,
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Preservation Tips', href: '/preservation' },
